...
public class AiUpdateNpcRoleForms implements Serializable {
  ...
  private List<AiUpdateNpcRoleFormsKnowledgeBases> knowledgeBases = null;
  ...
  **/
  ...
  public AiUpdateNpcRoleForms addKnowledgeBasesItem(AiUpdateNpcRoleFormsKnowledgeBases knowledgeBasesItem) {
    if (this.knowledgeBases == null) {
      this.knowledgeBases = new ArrayList<AiUpdateNpcRoleFormsKnowledgeBases>();
    }
  ...
  **/
  ...
  public AiUpdateNpcRoleForms llmModelId(Long llmModelId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, aiUpdateNpcRoleForms.id) &&
        ...
        Objects.equals(this.llmModelId, aiUpdateNpcRoleForms.llmModelId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, figureId, voiceId, characters, greetings, guidance, knowledgeBases, pluginIds, shortMemoryRound, operator, llmModelId);
  }
