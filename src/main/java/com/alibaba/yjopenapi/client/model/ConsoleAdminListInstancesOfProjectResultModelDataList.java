...
public class ConsoleAdminListInstancesOfProjectResultModelDataList implements Serializable {
  ...
  **/
  ...
  public ConsoleAdminListInstancesOfProjectResultModelDataList effectiveTime(Long effectiveTime) {
  ...
  **/
  ...
  public ConsoleAdminListInstancesOfProjectResultModelDataList expireTime(Long expireTime) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commoditySpecificationCnName, bandwidthChargeType, effectiveTime, platformType, paymentType, token, expireTime, commodityInstanceName, commodityInstanceId, region, projectId, containerCount, status, tradeChannel);
  }
