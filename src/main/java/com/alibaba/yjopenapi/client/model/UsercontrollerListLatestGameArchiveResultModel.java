...
public class UsercontrollerListLatestGameArchiveResultModel implements Serializable {
  ...
  public UsercontrollerListLatestGameArchiveResultModel pageNumber(String pageNumber) {
  ...
  **/
  ...
  public UsercontrollerListLatestGameArchiveResultModel pageSize(String pageSize) {
  ...
  **/
  ...
  public UsercontrollerListLatestGameArchiveResultModel totalCount(String totalCount) {
