...
public class QuerySessionStatusResultModel implements Serializable {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.code, querySessionStatusResultModel.code) &&
        ...
        Objects.equals(this.gameId, querySessionStatusResultModel.gameId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, message, success, tenantId, projectId, gameId, gameSession, status, accountId, userLevel, regionId, dispatchTime, stopTime, playTime);
  }
