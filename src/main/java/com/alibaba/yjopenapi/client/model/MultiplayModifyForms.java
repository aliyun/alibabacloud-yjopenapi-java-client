...
import com.alibaba.yjopenapi.client.model.MultiplayModifyTokens;
...
public class MultiplayModifyForms implements Serializable {
  ...
  private List<MultiplayModifyTokens> tokens = null;
  ...
  **/
  ...
  public MultiplayModifyForms tokens(List<MultiplayModifyTokens> tokens) {
    this.tokens = tokens;
    return this;
  }

  public MultiplayModifyForms addTokensItem(MultiplayModifyTokens tokensItem) {
    if (this.tokens == null) {
      this.tokens = new ArrayList<MultiplayModifyTokens>();
    }
   ...
   * @return tokens
  **/
  public List<MultiplayModifyTokens> getTokens() {
    return tokens;
  }

  public void setTokens(List<MultiplayModifyTokens> tokens) {
    this.tokens = tokens;
  }
