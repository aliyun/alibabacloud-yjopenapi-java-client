...
import com.alibaba.yjopenapi.client.model.AiUploadModelsResultModel;
...
public class AiUploadModelsResult implements Serializable {
  ...
  private AiUploadModelsResultModel model = null;
  ...
  **/
  ...
  public AiUploadModelsResult model(AiUploadModelsResultModel model) {
    this.model = model;
    return this;
  }
   ...
   * @return model
  **/
  public AiUploadModelsResultModel getModel() {
    return model;
  }

  public void setModel(AiUploadModelsResultModel model) {
    this.model = model;
  }
