...
public class AiCreateNpcRoleForms implements Serializable {
  ...
  private List<AiCreateNpcRoleFormsKnowledgeBases> knowledgeBases = null;
  ...
  **/
  ...
  public AiCreateNpcRoleForms addKnowledgeBasesItem(AiCreateNpcRoleFormsKnowledgeBases knowledgeBasesItem) {
    if (this.knowledgeBases == null) {
      this.knowledgeBases = new ArrayList<AiCreateNpcRoleFormsKnowledgeBases>();
    }
  ...
  **/
  ...
  public AiCreateNpcRoleForms llmModelId(Long llmModelId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, aiCreateNpcRoleForms.name) &&
        ...
        Objects.equals(this.llmModelId, aiCreateNpcRoleForms.llmModelId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, figureId, voiceId, characters, greetings, guidance, knowledgeBases, pluginIds, shortMemoryRound, tenantId, operator, llmModelId);
  }
  ...
  public String toString() {
    ...
    sb.append(",llmModelId: ").append(toIndentedString(llmModelId));
    sb.append("}");
    return sb.toString();
  }
